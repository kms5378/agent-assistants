        ...
        return [
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "recurrence": {
                            ...
                            "required": ["type", "days_of_week", "day_of_month", "local_time"],
                            "additionalProperties": False,
                        },
                        "delivery_channel": {"type": "string"},
                        "notes": {"type": ["string", "null"]},
                    },
                    "required": ["title", "due_at_local", "timezone", "recurrence", "delivery_channel", "notes"],
                    "additionalProperties": False,
                },
            },
            {
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "delete_scope": {"type": ["string", "null"], "enum": ["single", "series", None]},
                    },
                    "required": ["reminder_id", "query", "delete_scope"],
                    "additionalProperties": False,
                },
            },
            {
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "required": ["start_local", "end_local", "timezone", "calendar_id"],
                    "additionalProperties": False,
                },
            },
            {
                ...
                "parameters": {
                    ...
                    "required": ["title", "start_local", "end_local", "timezone", "description", "location", "calendar_id"],
                    "additionalProperties": False,
                },
            },
            {
                ...
                "parameters": {
                    ...
                    "required": ["event_id", "timezone", "title", "start_local", "end_local", "description", "location", "calendar_id"],
                    "additionalProperties": False,
                },
            },
        ]
